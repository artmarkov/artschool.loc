...
use common\models\teachers\Position;
...
$this->title = Yii::t('yee/teachers','Position');
...
<div class="position-index">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <?= Html::a(Yii::t('yee', 'Add New'), ['/teachers/position/create'], ['class' => 'btn btn-sm btn-primary']) ?>
        </div>
    </div>
