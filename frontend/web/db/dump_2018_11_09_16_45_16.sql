...
INSERT INTO `menu_link` VALUES ('about','main-menu','/site/about','','',1,1,NULL,1539032378,1,4),('about-guest','guest-menu','/site/about','','info-circle',1,999,1535632863,1539026104,4,4),('adminsystem','admin-menu','','','adn',0,32,1534760250,1535709021,1,4),('auditory','admin-menu','/auditory/default/index','auditory_main','',0,44,1538330997,1538931299,4,4),('auditory_building','admin-menu','/auditory/building/index','auditory_main','',0,46,1538331128,1538331128,4,4),('auditory_cat','admin-menu','/auditory/cat/index','auditory_main','',0,45,1538331072,1538331072,4,4),('auditory_main','admin-menu','/auditory/default/index','guide','',0,43,1538331205,1538640705,4,4),('bd','admin-menu','/db','','database',0,67,1537187091,1537187166,4,4),('bd2','admin-menu','/db-manager/default/index','','database',0,68,1537192847,1537192847,4,4),('bonus-category','admin-menu','/teachers/bonus-category/index','teachers','',0,61,1539637397,1540029713,4,4),('bonus-item','admin-menu','/teachers/bonus-item/index','teachers','',0,62,1539677454,1540029726,4,4),('comment','admin-menu','/comment/default/index','','comment',0,10,NULL,NULL,1,NULL),('company','main-menu','/company/index','tables','',0,5,1540996061,1540996792,4,4),('cost','admin-menu','/teachers/cost/index','teachers','',0,59,1539637430,1539637430,4,4),('dashboard','admin-menu','/','','th',0,0,NULL,NULL,1,NULL),('department','admin-menu','/service/department/index','structure','',0,37,1540198483,1540198564,4,4),('direction','admin-menu','/teachers/direction/index','teachers','',0,58,1539637630,1539637630,4,4),('division','admin-menu','/service/division/index','structure','',0,36,1540198513,1540198549,4,4),('eav','admin-menu','','','code',0,19,NULL,1535709062,1,4),('eav-attribute','admin-menu','/eav/attribute/index','eav','',0,21,NULL,1535709110,1,4),('eav-eav','admin-menu','/eav/default/index','eav','',0,20,NULL,1535709096,1,4),('eav-model','admin-menu','/eav/entity-model/index','eav','',0,23,NULL,1535709137,1,4),('eav-option','admin-menu','/eav/attribute-option/index','eav','',0,22,NULL,1535709126,1,4),('eav-type','admin-menu','/eav/attribute-type/index','eav','',0,24,NULL,1535709153,1,4),('guide','admin-menu','','','inbox',0,34,1538330899,1538330899,4,4),('home','main-menu','/site/index','','th',1,0,NULL,1535622585,1,4),('home-guest','guest-menu','/site/index','','th',1,999,1535629294,1535708816,4,4),('image-settings','admin-menu','/media/default/settings','settings',NULL,0,29,NULL,NULL,1,NULL),('level','admin-menu','/teachers/level/index','teachers','',0,56,1539637680,1539637680,4,4),('measure-unit','admin-menu','/service/measure-unit/index','guide','',0,52,1539974585,1540029697,4,4),('measure1','main-menu','/measure/index','tables','',0,3,1534756048,1535708973,1,4),('measureAdmin','admin-menu','/measure/index','adminsystem','amazon',0,33,1531125317,1534927685,1,1),('media','admin-menu',NULL,'','image',0,6,NULL,NULL,1,NULL),('media-album','admin-menu','/media/album/index','media',NULL,0,8,NULL,NULL,1,NULL),('media-category','admin-menu','/media/category/index','media',NULL,0,9,NULL,NULL,1,NULL),('media-media','admin-menu','/media/default/index','media',NULL,0,7,NULL,NULL,1,NULL),('menu','admin-menu','/menu/default/index','','align-justify',0,11,NULL,NULL,1,NULL),('option','main-menu','/option/index','tables','',0,4,1535369181,1535708981,4,4),('page','admin-menu','/page/default/index','','file',0,1,NULL,NULL,1,NULL),('parent','admin-menu','/parent/default/index','student-main','',0,65,1541107372,1541150857,4,4),('position','admin-menu','/teachers/position/index','teachers','',0,55,1539637723,1539637748,4,4),('post','admin-menu',NULL,'','pencil',0,2,NULL,NULL,1,NULL),('post-category','admin-menu','/post/category/index','post',NULL,0,5,NULL,NULL,1,NULL),('post-post','admin-menu','/post/default/index','post',NULL,0,3,NULL,NULL,1,NULL),('post-tag','admin-menu','/post/tag/index','post','',0,4,NULL,1535709768,1,4),('seo','admin-menu','/seo/default/index','','line-chart',0,25,NULL,NULL,1,NULL),('settings','admin-menu',NULL,'','cog',0,26,NULL,NULL,1,NULL),('settings-cache','admin-menu','/settings/cache/flush','settings',NULL,0,31,NULL,NULL,1,NULL),('settings-general','admin-menu','/settings/default/index','settings',NULL,0,27,NULL,NULL,1,NULL),('settings-reading','admin-menu','/settings/reading/index','settings',NULL,0,28,NULL,NULL,1,NULL),('settings-translations','admin-menu','/translation/default/index','settings',NULL,0,30,NULL,NULL,1,NULL),('stake','admin-menu','/teachers/stake/index','teachers','',0,60,1539637778,1539637778,4,4),('structure','admin-menu','/service/division/index','guide','',0,35,1540317933,1540318055,4,4),('student','admin-menu','/student/default/index','student-main','',0,64,1540547451,1540847778,4,4),('student-main','admin-menu','/student/default/index','','male',0,63,1540547742,1540547742,4,4),('student-position','admin-menu','/student/position/index','student-main','',0,66,1540547535,1540547535,4,4),('subject','admin-menu','/subject/default/index','guide','',0,47,1540241782,1540242124,4,4),('subject-category','admin-menu','/subject/category-item/index','subject','',0,49,1540241905,1540242227,4,4),('subject-item','admin-menu','/subject/default/index','subject','',0,48,1540241832,1540242109,4,4),('subject-type','admin-menu','/subject/type/index','subject','',0,51,1540369650,1540369650,4,4),('subject-vid','admin-menu','/subject/vid/index','subject','',0,50,1540326068,1540326068,4,4),('tables','main-menu','','','',0,2,1535443564,1535708959,4,4),('teachers','admin-menu','','','user-secret',0,53,1539637231,1539700635,4,4),('teachers_user','admin-menu','/teachers/default/index','teachers','',0,54,1539637888,1540847759,4,4),('user','admin-menu',NULL,'','user',0,12,NULL,NULL,1,NULL),('user-groups','admin-menu','/user/permission-groups/index','user',NULL,0,16,NULL,NULL,1,NULL),('user-log','admin-menu','/user/visit-log/index','user',NULL,0,17,NULL,NULL,1,NULL),('user-permission','admin-menu','/user/permission/index','user',NULL,0,15,NULL,NULL,1,NULL),('user-relation','admin-menu','/user/relation/index','user','',0,18,1540648763,1540648763,4,4),('user-role','admin-menu','/user/role/index','user',NULL,0,14,NULL,NULL,1,NULL),('user-user','admin-menu','/user/default/index','user',NULL,0,13,NULL,NULL,1,NULL),('venue','admin-menu','/venue/default/index','guide','',0,38,1538640393,1539178555,4,4),('venue_country','admin-menu','/venue/country/index','venue','',0,40,1538640228,1538640228,4,4),('venue_district','admin-menu','/venue/district/index','venue','',0,42,1538640332,1538640332,4,4),('venue_place','admin-menu','/venue/default/index','venue','',0,39,1538640139,1539178541,4,4),('venue_sity','admin-menu','/venue/sity/index','venue','',0,41,1538640257,1538640780,4,4),('work','admin-menu','/teachers/work/index','teachers','',0,57,1539637824,1539637824,4,4);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Ученики';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `student` VALUES (1,12,1,'','','','',566254800);
...
INSERT INTO `teachers` VALUES (1,14,1,1,1,5,NULL,'111',1472677200,NULL),(2,16,2,1,1,2,NULL,'111',NULL,NULL);
...
INSERT INTO `teachers_bonus` VALUES (1,1,1);
...
INSERT INTO `user_family` VALUES (1,1,12,20),(2,2,12,1);
...
CREATE TABLE `user_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Отношения в семье';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_relation` VALUES (1,'Мать','Мать'),(2,'Отец','Отец'),(3,'Бабушка','Баб');
...
-- Dump completed on 2018-11-09 16:45:18
