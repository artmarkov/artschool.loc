...
INSERT INTO `teachers_bonus` VALUES (1,1,1,1,1539726625,1,4);
...
INSERT INTO `teachers_cost` VALUES (1,1,1,18500),(2,1,2,20200),(3,1,3,21800),(4,1,4,23400),(6,2,2,19800),(7,2,3,21400),(8,2,4,23000);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Направление деятельности со ставкой преподавателя';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `teachers_direction_cost` VALUES (1,2,2,1,1),(2,1,3,1,0);
...
CREATE TABLE `teachers_position` (
  ...
  `slug` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='Должность';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-10-17 17:47:11
