...
CREATE TABLE `teachers` (
  ...
  `cost_main_id` tinyint(2) unsigned NOT NULL,
...
INSERT INTO `teachers` VALUES (1,1,1,1,6,1,'100',1224536400,1224536400);
...
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='Привязка характеристик к преподавателю';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `teachers_bonus` VALUES (39,1,2),(43,1,5),(45,1,4);
...
-- Dump completed on 2018-10-19 17:33:31
