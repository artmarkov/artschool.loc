...
CREATE TABLE `teachers_direction_cost` (
  ...
  KEY `direction_id` (`direction_id`),
  KEY `teachers_id` (`teachers_id`),
  CONSTRAINT `teachers_direction_cost_ibfk_1` FOREIGN KEY (`direction_id`) REFERENCES `teachers_direction` (`id`),
  CONSTRAINT `teachers_direction_cost_ibfk_2` FOREIGN KEY (`teachers_id`) REFERENCES `teachers` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Направление деятельности со ставкой преподавателя';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-10-15 17:52:31
