...
INSERT INTO `venue_country` VALUES (1,'Россия','RU'),(2,'Франция','FR'),(3,'Италия','IT'),(4,'Германия','GR'),(5,'Япония','JP');
...
INSERT INTO `venue_place` VALUES (1,1,1,1,'Департамент культуры г. Москвы','Неглинная улица, 8/10','+7 (495) 539 55 55','+7 (495) 539 55 55','','',55.645798,37.123455,'Открываются в 8 утра',0,1538737170,4,4);
...
INSERT INTO `venue_sity` VALUES (1,1,'Москва',55.753960,37.620392),(2,1,'Санкт-Петербург',NULL,NULL);
...
-- Dump completed on 2018-10-05 17:50:45
