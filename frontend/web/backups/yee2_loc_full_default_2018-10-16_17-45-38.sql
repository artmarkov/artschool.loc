...
INSERT INTO `eav_entity_attribute` VALUES (17,7,3,0),(149,10,2,0),(150,11,3,0),(163,4,3,0),(164,4,4,1),(165,4,5,2),(166,4,6,3),(167,4,7,4),(180,9,3,0),(181,9,4,1),(184,13,1,0),(185,13,2,1);
...
INSERT INTO `menu_link` VALUES ('about','main-menu','/site/about','','',1,2,NULL,1539032378,1,4),('about-guest','guest-menu','/site/about','','info-circle',1,999,1535632863,1539026104,4,4),('adminsystem','admin-menu','','','adn',0,31,1534760250,1535709021,1,4),('auditory','admin-menu','/auditory/default/index','auditory_main','',0,40,1538330997,1538931299,4,4),('auditory_building','admin-menu','/auditory/building/index','auditory_main','',0,42,1538331128,1538331128,4,4),('auditory_cat','admin-menu','/auditory/cat/index','auditory_main','',0,41,1538331072,1538331072,4,4),('auditory_main','admin-menu','/auditory/default/index','guide','',0,39,1538331205,1538640705,4,4),('bd','admin-menu','/db','','database',0,55,1537187091,1537187166,4,4),('bd2','admin-menu','/db-manager/default/index','','database',0,56,1537192847,1537192847,4,4),('bonus','admin-menu','/teachers/bonus/index','teachers','',0,52,1539637339,1539637339,4,4),('bonus-category','admin-menu','/teachers/bonus-category/index','teachers','',0,53,1539637397,1539637397,4,4),('bonus-item','admin-menu','/teachers/bonus-item/index','teachers','',0,54,1539677454,1539677454,4,4),('comment','admin-menu','/comment/default/index','','comment',0,10,NULL,NULL,1,NULL),('contact','main-menu','/site/contact','','',1,3,NULL,1539023181,1,4),('contact-guest','guest-menu','/site/contact','','paper-plane-o',1,999,1535632929,1539023160,4,4),('cost','admin-menu','/teachers/cost/index','teachers','',0,49,1539637430,1539637430,4,4),('dashboard','admin-menu','/','','th',0,0,NULL,NULL,1,NULL),('direction','admin-menu','/teachers/direction/index','teachers','',0,48,1539637630,1539637630,4,4),('direction-cost','admin-menu','/teachers/direction-cost/index','teachers','',0,51,1539637515,1539637515,4,4),('eav','admin-menu','','','code',0,18,NULL,1535709062,1,4),('eav-attribute','admin-menu','/eav/attribute/index','eav','',0,20,NULL,1535709110,1,4),('eav-eav','admin-menu','/eav/default/index','eav','',0,19,NULL,1535709096,1,4),('eav-model','admin-menu','/eav/entity-model/index','eav','',0,22,NULL,1535709137,1,4),('eav-option','admin-menu','/eav/attribute-option/index','eav','',0,21,NULL,1535709126,1,4),('eav-type','admin-menu','/eav/attribute-type/index','eav','',0,23,NULL,1535709153,1,4),('guide','admin-menu','','','inbox',0,33,1538330899,1538330899,4,4),('home','main-menu','/site/index','','th',1,0,NULL,1535622585,1,4),('home-guest','guest-menu','/site/index','','th',1,999,1535629294,1535708816,4,4),('image-settings','admin-menu','/media/default/settings','settings',NULL,0,28,NULL,NULL,1,NULL),('level','admin-menu','/teachers/level/index','teachers','',0,46,1539637680,1539637680,4,4),('measure1','main-menu','/measure/index','tables','',0,5,1534756048,1535708973,1,4),('measureAdmin','admin-menu','/measure/index','adminsystem','amazon',0,32,1531125317,1534927685,1,1),('media','admin-menu',NULL,'','image',0,6,NULL,NULL,1,NULL),('media-album','admin-menu','/media/album/index','media',NULL,0,8,NULL,NULL,1,NULL),('media-category','admin-menu','/media/category/index','media',NULL,0,9,NULL,NULL,1,NULL),('media-media','admin-menu','/media/default/index','media',NULL,0,7,NULL,NULL,1,NULL),('menu','admin-menu','/menu/default/index','','align-justify',0,11,NULL,NULL,1,NULL),('option','main-menu','/option/index','tables','',0,6,1535369181,1535708981,4,4),('page','admin-menu','/page/default/index','','file',0,1,NULL,NULL,1,NULL),('position','admin-menu','/teachers/position/index','teachers','',0,45,1539637723,1539637748,4,4),('post','admin-menu',NULL,'','pencil',0,2,NULL,NULL,1,NULL),('post-category','admin-menu','/post/category/index','post',NULL,0,5,NULL,NULL,1,NULL),('post-post','admin-menu','/post/default/index','post',NULL,0,3,NULL,NULL,1,NULL),('post-tag','admin-menu','/post/tag/index','post','',0,4,NULL,1535709768,1,4),('seo','admin-menu','/seo/default/index','','line-chart',0,24,NULL,NULL,1,NULL),('settings','admin-menu',NULL,'','cog',0,25,NULL,NULL,1,NULL),('settings-cache','admin-menu','/settings/cache/flush','settings',NULL,0,30,NULL,NULL,1,NULL),('settings-general','admin-menu','/settings/default/index','settings',NULL,0,26,NULL,NULL,1,NULL),('settings-reading','admin-menu','/settings/reading/index','settings',NULL,0,27,NULL,NULL,1,NULL),('settings-translations','admin-menu','/translation/default/index','settings',NULL,0,29,NULL,NULL,1,NULL),('stake','admin-menu','/teachers/stake/index','teachers','',0,50,1539637778,1539637778,4,4),('tables','main-menu','','','',0,4,1535443564,1535708959,4,4),('teachers','admin-menu','','','user-secret',0,43,1539637231,1539700635,4,4),('teachers_user','admin-menu','/teachers/default/index','teachers','',0,44,1539637888,1539637888,4,4),('user','admin-menu',NULL,'','user',0,12,NULL,NULL,1,NULL),('user-groups','admin-menu','/user/permission-groups/index','user',NULL,0,16,NULL,NULL,1,NULL),('user-log','admin-menu','/user/visit-log/index','user',NULL,0,17,NULL,NULL,1,NULL),('user-permission','admin-menu','/user/permission/index','user',NULL,0,15,NULL,NULL,1,NULL),('user-role','admin-menu','/user/role/index','user',NULL,0,14,NULL,NULL,1,NULL),('user-user','admin-menu','/user/default/index','user',NULL,0,13,NULL,NULL,1,NULL),('venue','admin-menu','/venue/default/index','guide','',0,34,1538640393,1539178555,4,4),('venue_country','admin-menu','/venue/country/index','venue','',0,36,1538640228,1538640228,4,4),('venue_district','admin-menu','/venue/district/index','venue','',0,38,1538640332,1538640332,4,4),('venue_place','admin-menu','/venue/default/index','venue','',0,35,1538640139,1539178541,4,4),('venue_sity','admin-menu','/venue/sity/index','venue','',0,37,1538640257,1538640780,4,4),('work','admin-menu','/teachers/work/index','teachers','',0,47,1539637824,1539637824,4,4);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Преподаватели';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `teachers` VALUES (1,1,1,1,'1',1,1);
...
CREATE TABLE `teachers_bonus` (
  ...
  KEY `apdated_by` (`updated_by`),
  KEY `params_item` (`bonus_item_id`),
  CONSTRAINT `teachers_bonus_ibfk_1` FOREIGN KEY (`updated_by`) REFERENCES `user` (`id`),
  CONSTRAINT `teachers_bonus_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `user` (`id`),
  CONSTRAINT `teachers_bonus_ibfk_3` FOREIGN KEY (`bonus_item_id`) REFERENCES `teachers_bonus` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Привязка характеристик к преподавателю';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `teachers_bonus` VALUES (1,1,1,1,1,1,1);
...
INSERT INTO `teachers_bonus_category` VALUES (1,'Ученая степень','Уч.ст',0),(2,'Звание','Звание',0),(3,'Уровень специалиста','Уровень',0),(4,'Специальные обязанности','Спец.обяз-ти',1);
...
CREATE TABLE `teachers_bonus_item` (
  ...
  `measure_id` smallint(6) DEFAULT NULL COMMENT 'ед. измерения',
...
INSERT INTO `teachers_bonus_item` VALUES (1,1,'Кандидат наук','КН','20',1,1,1),(2,1,'Доктор наук','ДН','30',1,1,1),(3,2,'Народный артист','НА','50',1,1,1),(4,2,'Заслуженный деятель искусств','ЗДИ','50',1,1,1),(5,2,'Заслуженный артист','ЗА','50',1,1,1),(6,2,'Заслуженный работник культуры','ЗРК','50',1,1,1),(7,2,'Заслуженный учитель','ЗУ','50',1,1,1),(8,2,'Почетный работник культуры','ПРК','30',1,1,1),(9,2,'Обладатель нагрудного знака','ОНЗ','30',1,1,1),(10,2,'Звание лауреата','ЗЛ','30',1,1,1),(11,3,'Специалист','С-т','0',1,1,1),(12,3,'Молодой специалист + проезд','МС+','55',1,1,1),(13,3,'Молодой специалист-отличник + проезд','МСО+','65',1,1,1),(14,4,'Руководство отделением','РО','30',1,1,1),(15,4,'Руководство выставочной работой','РВР','30',1,1,1),(16,4,'Участие в экспертной группе город','ЭГГ','30',1,1,1),(17,4,'Участие в экспертной группе округ','ЭГО','15',1,1,1),(18,4,'Заведование секцией','ЗС','15',1,1,1);
...
INSERT INTO `teachers_cost` VALUES (1,1,1,18500),(2,1,2,20200),(3,1,3,21800),(4,1,4,23400),(5,2,1,17700),(6,2,2,19800),(7,2,3,21400),(8,2,4,23000);
...
INSERT INTO `teachers_direction` VALUES (1,'Преподаватель','Преп-ль'),(2,'Концертмейстер','Конц-р');
/*!40000 ALTER TABLE `teachers_direction` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `teachers_direction_cost`
--

DROP TABLE IF EXISTS `teachers_direction_cost`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `teachers_direction_cost` (
  `id` tinyint(2) unsigned NOT NULL AUTO_INCREMENT,
  `direction_id` tinyint(2) unsigned NOT NULL,
  `stake_id` tinyint(2) unsigned NOT NULL,
  `teachers_id` mediumint(8) unsigned NOT NULL,
  `main_flag` tinyint(1) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `direction_id` (`direction_id`),
  KEY `teachers_id` (`teachers_id`),
  KEY `stake_id` (`stake_id`),
  CONSTRAINT `teachers_direction_cost_ibfk_2` FOREIGN KEY (`teachers_id`) REFERENCES `teachers` (`id`),
  CONSTRAINT `teachers_direction_cost_ibfk_3` FOREIGN KEY (`direction_id`) REFERENCES `teachers_direction` (`id`),
  CONSTRAINT `teachers_direction_cost_ibfk_4` FOREIGN KEY (`stake_id`) REFERENCES `teachers_stake` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Направление деятельности со ставкой преподавателя';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `teachers_direction_cost`
--

LOCK TABLES `teachers_direction_cost` WRITE;
/*!40000 ALTER TABLE `teachers_direction_cost` DISABLE KEYS */;
INSERT INTO `teachers_direction_cost` VALUES (1,1,1,1,1);
/*!40000 ALTER TABLE `teachers_direction_cost` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `teachers_stake` VALUES (1,'Без категории','БК'),(2,'Соответствие категории','СК'),(3,'Первая категория','ПК'),(4,'Высшая категория','ВК');
...
-- Dump completed on 2018-10-16 17:45:40
