...
namespace backend\modules\media\widgets\uploader;

use backend\modules\media\assets\MediaAsset;
use backend\modules\media\models\Media;
use backend\modules\media\models\MediaUpload;
use Yii;
...
abstract class UploaderController extends \yii\web\Controller
{
    ...
    public $modelClass = 'backend\modules\media\models\Media';
    ...
    public function actionDelete($id)
    {
        ...
        /**
         * @var backend\modules\media\models\Media
         */
        $model = Media::findOne([
            "{$tableName}.id" => $id,
