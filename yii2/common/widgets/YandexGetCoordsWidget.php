...
class YandexGetCoordsWidget extends InputWidget
{
  ...
  public function run(){
    ...
    if($this->hasModel()){
      ...
      $address_input = Html::activeInput('text',$this->model,$this->address_attribute,['class'=>'form-control']);
      ...
      $address_input = Html::activeInput('text',$this->address_attribute,'',['class'=>'form-control']);
